...
/// state is silence; a sound is presentation, never state. Text the user
/// edits here is delivered verbatim — their words are theirs. This file
/// states no colour of its own.
