...
- [ ] 5.2 Three-surface agreement at one instant. Red: `FocusCapsuleTests.testThreeSurfacesAgreeAtOneInstant`. Green: focus, popover, and capsule render identical remaining text, task line, and status line from one snapshot. Files: `app/Tests/PraxmodoroTests/FocusCapsuleTests.swift`.
