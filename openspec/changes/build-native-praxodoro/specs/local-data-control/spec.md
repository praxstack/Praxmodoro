...
#### Scenario: [LDC-S001] Data dictionary audit
...
#### Scenario: [LDC-S002] Network loss during focus
...
#### Scenario: [LDC-S003] Offline network capture
...
#### Scenario: [LDC-S004] Default retention manifest
...
#### Scenario: [LDC-S005] Retention cleanup
...
#### Scenario: [LDC-S006] Default completion cleanup
...
#### Scenario: [LDC-S007] Private history opt-in
...
#### Scenario: [LDC-S008] Completed-sessions-only sync
...
#### Scenario: [LDC-S009] Sync unavailable or denied
...
#### Scenario: [LDC-S010] Permission timing
...
#### Scenario: [LDC-S011] Default preview
...
#### Scenario: [LDC-S012] Event deduplication
...
#### Scenario: [LDC-S013] System quiet settings
...
#### Scenario: [LDC-S014] Minimal export
...
#### Scenario: [LDC-S015] Export after downgrade
...
#### Scenario: [LDC-S016] Successful local delete all
...
#### Scenario: [LDC-S017] Partial synced deletion
...
#### Scenario: [LDC-S018] Exported files and backups
...
#### Scenario: [LDC-S019] Diagnostic event
...
#### Scenario: [LDC-S020] Permission and entitlement audit
...
#### Scenario: [LDC-S022] Migration failure
