...
#### Scenario: Start without capacity
...
#### Scenario: Deterministic breakdown
...
#### Scenario: AI suggestion acceptance
...
#### Scenario: Detour suggestion reason
...
The system SHALL make check-ins optional, configurable, manually triggerable, dismissible, and semantically selectable.

#### Scenario: Due check-in choices
...
#### Scenario: Cadence changes during session
...
#### Scenario: Relaunch in low-cognitive-load mode
...
#### Scenario: Eligible descriptive pattern
...
#### Scenario: Intentional early stop
...
#### Scenario: Pro capability requested during focus
